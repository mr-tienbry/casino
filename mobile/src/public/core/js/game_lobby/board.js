...
function showDefault() {
    ...
    <div _ngcontent-serverapp-c162="" class="Board block text-left" id="list-product-board" style="padding: 10px;">
        <!-- <div _ngcontent-serverapp-c162="" class="third:mr-0 relative mt-[2%] mr-[1%] box-border inline-block min-h-[82px] w-[32%] min-w-[74px] text-center">
            <div data-product="V8" onclick="openBoardProduct($(this))" _ngcontent-serverapp-c162="" class="relative flex h-[64px] items-center justify-center">
            ...
            <div _ngcontent-serverapp-c162="" class="bg-customized-bg-quaternary text-customized-text-secondary h-[26px] truncate rounded-b text-center text-sm leading-[22px] tracking-tighter">
                <span _ngcontent-serverapp-c162="" class="text-xs">V8
                    Game
                    Bài</span>
            </div>
        </div> -->
        ...
        <div _ngcontent-serverapp-c162="" class="third:mr-0 relative mt-[2%] mr-[1%] box-border inline-block min-h-[82px] w-[32%] min-w-[74px] text-center">
            <div data-product="RICH88" onclick="openBoardProduct($(this))" _ngcontent-serverapp-c162="" class="relative flex h-[64px] items-center justify-center">
            ...
            <div _ngcontent-serverapp-c162="" class="bg-customized-bg-quaternary text-customized-text-secondary h-[26px] truncate rounded-b text-center text-sm leading-[22px] tracking-tighter">
                <span _ngcontent-serverapp-c162="" class="text-xs">RICH88
                    Game
                    Bài</span>
            </div>
        </div>
