...
module.exports = {
  ...
  createRequestWithdraw: async (req, res) => {
    try {
      ...
      const botTeleConfig = JSON.parse(fs.readFileSync("./src/configs/telegram/bot.json", "utf8"));
      const chatTeleConfig = JSON.parse(fs.readFileSync("./src/configs/telegram/chatGroup.json", "utf8"));
      const messageTeleConfig = JSON.parse(fs.readFileSync("./src/configs/telegram/message.json", "utf8"));
